...
export const useStore = zustandContext.useStore as UseContextStore<StoreApi<TokenState>>

export const initializeStore = (preloadedState?: string) => {
    const state = preloadedState ? JSON.parse(preloadedState) as Partial<TokenState> : undefined
